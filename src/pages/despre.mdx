...
În afara facultății, care îmi mănâncă zilele, îmi ocup timpul cu activități algoritmice (scris pe InfoGenius, predat la InfoGym, organizat FIICode, comisie OJI/ONI, pregătiri OJI), citind Eric Schmidt și contemplând marii gânditori ai istoriei, de la Karl Marx până la Kazi Ploae. Din când în când, mă regăsesc făcând web dev, lucrând la site-uri precum cel de față. Totodată, în funcție de sezon, mai ies pe afară cu bicla sau mai fac câte-o excursie.
...
- Odată [am petrecut 3 ore](/intalnire-bagabont) vorbind despre marxism cu un bagabont de pe stradă.
...
<div class="my-8 flex gap-8 max-lg:flex-col-reverse [&_p]:m-0">
  <div>
    ...
    Ah, iată că am făcut și un playlist cu 150 de piese: [Romanian Hip-Hop](https://open.spotify.com/playlist/2x74UZ8VCeLeSgDjmTkYz7?si=613ab940f84449fd)!
  </div>
  <div class="max-w-sm">
